            ...
            when(response) {
                is Resource.Success -> {
                    ...
                    response.data?.let { newsResponse ->
                        newsAdapter.differ.submitList(newsResponse.articles.toList()) // async list differ works with mutable list? prolly
                        val totalPages = newsResponse.totalResults / QUERY_PAGE_SIZE + 2 // why add 2?
